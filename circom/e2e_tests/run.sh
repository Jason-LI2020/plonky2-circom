...
POT_PATH=/data/download/ptau/powersOfTau28_hez_final_24.ptau
RAPIDSNARK_PATH=../../../../rapidsnark/build/prover
# node version > 18
NODE_PATH=node
SNARKJS_PATH=/home/ubuntu/snarkjs/cli.js
NODE_PARAMS="--trace-gc --trace-gc-ignore-scavenger --max-old-space-size=2048000 --initial-old-space-size=2048000 --no-incremental-marking --max-semi-space-size=1024 --initial-heap-size=2048000 --expose-gc"
...
${NODE_PATH} ${SNARKJS_PATH} zkesc public.json proof.json > ./hardhat/test/public.txt
